...
const songs = [
    { sName: "Cielo - Huma-Huma", sCover: "./covers/1.jpg", sPath: "./songs/1.mp3" },
    { sName: "Cielo - Huma-Huma-2", sCover: "./covers/2.jpg", sPath: "./songs/2.mp3" },
    { sName: "DEAF KEV - Invincible [NCS Release]-320k", sCover: "./covers/3.jpg", sPath: "./songs/3.mp3" },
    { sName: "Different Heaven & EH!DE", sCover: "./covers/4.jpg", sPath: "./songs/4.mp3" },
    { sName: "Janji-Heroes-Tonight-feat", sCover: "./covers/5.jpg", sPath: "./songs/5.mp3" },
    { sName: "Rabba - Salam-e-Ishq", sCover: "./covers/6.jpg", sPath: "./songs/6.mp3" },
    { sName: "Ham tere bina jeena", sCover: "./covers/7.jpg", sPath: "./songs/7.mp3" },
    { sName: "Hoke judda tujhse", sCover: "./covers/8.jpg", sPath: "./songs/8.mp3" },
    { sName: "Love to me for you", sCover: "./covers/9.jpg", sPath: "./songs/9.mp3" },
    { sName: "Na Jaana - Salam-e-Ishq", sCover: "./covers/10.jpg", sPath: "./songs/10.mp3" },
]
...
function songItem() {
    document.querySelector("#SongNameMaster").innerHTML = songs[parseInt(this.classList[0]) - 1].sName;
    ...
    masterPlayBtn.classList.replace(masterPlayBtn.classList[0], `${PreviousPlaySong}`)
    masterPlayBtnControl();
}
